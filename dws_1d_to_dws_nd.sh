...
case $1 in
    "all")
        hive -e "SET hive.execution.engine=mr; SET hive.exec.parallel=false; $dws_trade_user_sku_order_nd$dws_trade_province_order_nd SET hive.execution.engine=spark; SET hive.exec.parallel=true;" ;;
esac
