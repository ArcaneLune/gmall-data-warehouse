...
case $1 in
    "all")
        hive -e "SET hive.execution.engine=mr; SET hive.exec.parallel=false; $dws_trade_user_order_td$dws_user_user_login_td SET hive.execution.engine=spark; SET hive.exec.parallel=true;" ;;
esac
