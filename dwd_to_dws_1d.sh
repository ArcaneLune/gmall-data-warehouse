...
case $1 in
    "all")
        hive -e "SET hive.execution.engine=mr; SET hive.exec.parallel=false; $dws_trade_user_sku_order_1d$dws_trade_user_order_1d$dws_trade_user_cart_add_1d$dws_trade_user_payment_1d$dws_trade_province_order_1d$dws_tool_user_coupon_coupon_used_1d$dws_interaction_sku_favor_add_1d$dws_traffic_session_page_view_1d$dws_traffic_page_visitor_page_view_1d SET hive.execution.engine=spark; SET hive.exec.parallel=true;" ;;
esac
